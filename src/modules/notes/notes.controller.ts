import {Controller, Get, Post, Body, Param, Put, Delete, ParseIntPipe, UsePipes, UseGuards} from '@nestjs/common';
import {NotesService} from './notes.service';
import {CreateNoteDto} from './dto/create-note.dto';
import {UpdateNoteDto} from './dto/update-note.dto';
import {ApiTags, ApiResponse, ApiSecurity, ApiBearerAuth} from '@nestjs/swagger';
